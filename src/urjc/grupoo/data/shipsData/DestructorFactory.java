...
public class DestructorFactory extends ShipFactory {
    ...
    public Destructor CreateSpaceship(String Type, int crewmembers, String propname1, Double maxSpeed1, String propname2, Double maxSpeed2, String registernumber,
